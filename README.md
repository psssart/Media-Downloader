...
- **Auto Cleanup**: Downloaded files are automatically cleaned up after a configurable period
...
|----------|---------|-------------|
| `MD_FILE_RETENTION_HOURS` | 24 | Auto-delete files after this many hours |
| `MD_CLEANUP_INTERVAL_MINUTES` | 30 | How often to run cleanup |
